...
* Fix: Compatibility updates for Letterboxd
  * The HTML and CSS class for release year was changed
  * A change to the Letterboxd Extras browser addon meant that the PTP button would be removed when it adds its links to other external websites
